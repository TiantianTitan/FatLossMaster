...
import { calculateCalorieDeficit } from '../../lib/calculations'
import { calculateMonthlyStats, calculateWeeklyStats, type PeriodStats } from '../../lib/statistics'

type Range = '7'|'30'|'90'|'all'; type Metric = 'weight'|'waist'|'intake'|'deficit'|'protein'
const ranges: Array<[Range,string]> = [['7','7天'],['30','30天'],['90','3个月'],['all','全部']]
const metrics: Array<[Metric,string,string]> = [['weight','体重','kg'],['waist','腰围','cm'],['intake','摄入','kcal'],['deficit','热量缺口','kcal'],['protein','蛋白质','g']]
const getValue = (r: DailyRecord, metric: Metric) => metric==='weight'?r.weightKg:metric==='waist'?r.waistCm:metric==='intake'?r.foodCalories:metric==='deficit'?calculateCalorieDeficit(r):r.proteinGrams
