...
const getValue = (r: DailyRecord, metric: Metric) => metric==='weight'?r.weightKg:metric==='waist'?r.waistCm:metric==='intake'?getFoodCalories(r):metric==='deficit'?calculateCalorieDeficit(r):getProteinGrams(r)
