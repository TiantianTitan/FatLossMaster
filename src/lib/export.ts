...
export const exportCSV = (records: DailyRecord[]) => {
  const keys = ['date','sex','ageYears','heightCm','weightKg','waistCm','sleepHours','stepCount','restingCalories','dailyCalories','exerciseCalories','totalCalories','foodCalories','proteinGrams','calorieDeficit','notes'] as const
